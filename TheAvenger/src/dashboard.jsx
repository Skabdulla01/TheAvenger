...
function dashboard() {
  ...
  return (
    <>
      {/* <Avengerprofile flexdirection="column" name={captainAmarica.hero} story={captainAmarica.story} realname={captainAmarica.realname} png={captainamaricapng} TextStroke={captainAmarica.TextStroke} colour1={captainAmarica.colour1} colour2={captainAmarica.colour2} rgb={captainAmarica.rgb} scale="scale(0.6)"/> */}
